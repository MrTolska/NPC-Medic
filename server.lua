...
QBCore.Functions.CreateCallback('BammsMedic:docOnline', function(source, cb)
	local src = source
...
RegisterServerEvent('BammsMedic:charge')
AddEventHandler('BammsMedic:charge', function()
	local src = source
